...
export default function AddJobPage() {
  ...
  const [showTableBuilder, setShowTableBuilder] = useState<string | null>(null); // 'description', 'applicationProcess', etc.
              ...
              <div>
                ...
                {showTableBuilder === "description" && (
                  <div className="mb-3">
                    <TableBuilder
                      onInsert={(html) => {
                        updateField("description", jobData.description + html);
                  ...
                  <div className="mb-3">
                    <TableBuilder
                      onInsert={(html) => {
                        updateField(
                          "applicationProcess",
                          jobData.applicationProcess + html
                        );
                        setShowTableBuilder(null);
                      }}
                    />
              ...
              <div>
                ...
                {showTableBuilder === "howToApply" && (
                  <div className="mb-3">
                    <TableBuilder
                      onInsert={(html) => {
                        updateField("howToApply", jobData.howToApply + html);
                        setShowTableBuilder(null);
                      }}
                    />
                  </div>
